        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Department_Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Number_Phone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Head_Department = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_Post = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title_Post = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserLoginHistory_User_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLoginHistory_ApplicationUserId",
                schema: "Identity",
